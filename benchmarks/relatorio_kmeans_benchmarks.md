...
| --- | ---: |
| Sequencial | 19.531 |
| OpenMP 4 threads | 5.828 |
| CUDA | 3.979 |

A GPU reduziu significativamente o tempo da etapa principal do K-Means, levando
`kmeans_cuda` a 1.750357 s contra 4.234563 s da melhor versao OpenMP medida.
Ainda assim, `printEPS()` continua relevante no tempo total, especialmente
porque a saida EPS e gerada para todos os 5.000.000 pontos.
